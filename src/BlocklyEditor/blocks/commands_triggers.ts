...
javascriptGenerator['commands_task_step'] = function (block: Blockly.Block) {
  const value_command = javascriptGenerator.valueToCode(block, 'COMMAND', javascriptGenerator.ORDER_ATOMIC);
  const value_trigger = javascriptGenerator.valueToCode(block, 'TRIGGER', javascriptGenerator.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  const code = `[${value_command}, ${value_trigger}]`;
...
javascriptGenerator['triggers_timer'] = function (block: Blockly.Block) {
  const value_time = javascriptGenerator.valueToCode(block, 'TIME', javascriptGenerator.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  const code = `timer(${value_time})`;
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, javascriptGenerator.ORDER_ATOMIC];
};
...
javascriptGenerator['triggers_intersection'] = function (block: Blockly.Block) {
  ...
  // TODO: Assemble JavaScript into code variable.
  const code = `intersection('${dropdown_name}')`;
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, javascriptGenerator.ORDER_ATOMIC];
};
...
javascriptGenerator['commands_drive'] = function (block: Blockly.Block) {
  const value_angle = javascriptGenerator.valueToCode(block, 'angle', javascriptGenerator.ORDER_ATOMIC);
  ...
  const code = `drive([${value_angle}, ${value_speed}])`;
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, javascriptGenerator.ORDER_ATOMIC];
};
